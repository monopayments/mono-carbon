...
import { addLiquidity, calculateCD,  getCDTokensBalance,
    getEtherBalance,
    getLPTokensBalance,
    getReserveOfCDTokens,  getTokensAfterRemove,
    removeLiquidity,swapTokens, getAmountOfTokensReceivedFromSwap } from "../utils/web3/dex";
/*
import {
  getCDTokensBalance,
  getEtherBalance,
...
export default function Swap() {
  ...
  const getProviderOrSigner = async (needSigner = false) => {
    ...
    if (chainId !== 43_113) {
      window.alert("Change the network to Fuji");
      throw new Error("Change network to Fuji");
    }
        ...
        <div>
          ...
          <div>
            ...
            <div>
              ...
              <button  onClick={_removeLiquidity}>
                Remove
              </button>
            </div>
          </div>
...
<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
      ...
      <div>
        <div>
          <h1 >Welcome to Crypto Devs Exchange!</h1>
          <div>
